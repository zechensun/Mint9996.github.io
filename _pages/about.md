...
**Zechen Sun**, Zecheng Tang, Juntao Li, Wenpeng Hu, Wenliang Chen, Zhunchen Luo, Qiaoming Zhu, **AAAI 2026**.
...
**Zechen Sun**, Yuyang Sun, Zhaochen Su, Zecheng Tang, Juntao Li†, Wenliang Chen, Ao Zhou, Min Zhang, **TACL Conditional Accept**.
...
Zecheng Tang, **Zechen Sun**, Juntao Li, Qiaoming Zhu, Min Zhang, **ICML 2025**.
...
- We investigate whether LLMs exhibit shortcut learning behavior and its root causes (pre-training vs. instruction fine-tuning). We propose FSLI, a method that effectively suppresses LLMs' reliance on shortcut features in ICL settings, improving reasoning capabilities.
</div>
</div>
...
Yisheng Xiao♡, Pei Guo♡, **Zechen Sun♡**, Juntao Li, Kai Song, Min Zhang &nbsp; (♡equal contribution), **ACL 2025**. 
...
Yisheng Xiao, Juntao Li, **Zechen Sun**, Zechang Li, Qingrong Xia, Xinyu Duan, Zhefeng Wang, Min Zhang, **ICLR 2024**. 
